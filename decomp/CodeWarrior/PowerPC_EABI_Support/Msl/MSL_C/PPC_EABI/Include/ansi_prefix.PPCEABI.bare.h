...
/* added for Dolphin so it can setup time functions */
// #define _Dolphin_PPC_EABI_OS
...
/*  Change Record
 *	20-Jul-97 MEA   changed __ppc_eabi_bare to __ppc_eabi.  Added
