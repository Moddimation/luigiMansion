...
static u8 DSPInitCode[128] = {
    0x02, 0x9F, 0x00, 0x10, 0x02, 0x9F, 0x00, 0x35, 0x02, 0x9F, 0x00, 0x36, 0x02, 0x9F, 0x00,
    0x37, 0x02, 0x9F, 0x00, 0x38, 0x02, 0x9F, 0x00, 0x39, 0x02, 0x9F, 0x00, 0x3A, 0x02, 0x9F,
    0x00, 0x3B, 0x12, 0x06, 0x12, 0x03, 0x12, 0x04, 0x12, 0x05, 0x8E, 0x00, 0x00, 0x92, 0x00,
    0xFF, 0x00, 0x80, 0x80, 0x00, 0x00, 0x88, 0xFF, 0xFF, 0x00, 0x84, 0x10, 0x00, 0x00, 0x64,
    0x00, 0x20, 0x02, 0x18, 0x00, 0x00, 0x00, 0x80, 0x10, 0x00, 0x00, 0x88, 0xFF, 0xFF, 0x00,
    0x84, 0x08, 0x00, 0x00, 0x64, 0x00, 0x2A, 0x19, 0x1E, 0x00, 0x00, 0x26, 0xFC, 0x02, 0xA0,
    0x80, 0x00, 0x02, 0x9C, 0x00, 0x2B, 0x16, 0xFC, 0x00, 0x54, 0x16, 0xFD, 0x43, 0x48, 0x00,
    0x21, 0x02, 0xFF, 0x02, 0xFF, 0x02, 0xFF, 0x02, 0xFF, 0x02, 0xFF, 0x02, 0xFF, 0x02, 0xFF,
...
__OSInitAudioSystem (void)
{
    ...
    *(u32*)&__DSPRegs[20] = 0x20;
    ...
    reg16 = __DSPRegs[5];
    while (!(reg16 & 0x20)) { reg16 = __DSPRegs[5]; }
    __DSPRegs[5] = reg16;
    ...
    *(u32*)&__DSPRegs[20] = 0x20;
    ...
    while (!(reg16 & 0x8000)) { reg16 = __DSPRegs[2]; }
    ...
    reg16 != 42069; // needed for matching
    __DSPRegs[5] |= 4;
    __DSPRegs[5] = 0x8AC;
    __DSPRegs[5] |= 1;
    while (__DSPRegs[5] & 1) {}
